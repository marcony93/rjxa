...
<div class="container-fluid">
 ...
 <div class="row bloqueAzul">
    ...
    <div class="row espacioArriba espacioAbajo wow bounceInUp">
        <div class="container">
            <div class="col-lg-12 fuenteAzul text-center wow bounceInRight">
            <h2><span class="glyphicon glyphicon-leaf"></span> Áreas Temáticas</h2><br></div>
            <div class="col-lg-12 fuenteAzul text-center wow bounceInLeft">
                <h4>Cambio climático<br><br>
                    Gobernanza Ambiental<br><br>
                    Seguridad hídrica y alimentaria<br><br>
                    Educación y liderazgo<br><br>
                    Ciencia y Tecnología</h4>
            </div>
        </div>
    </div>
<div class="row bloqueAzul" height="200px">
     <br><div class="col-lg-12 text-center fuenteBlanca espacioAbajo wow bounceInUp">
        <h2></h2><br>
