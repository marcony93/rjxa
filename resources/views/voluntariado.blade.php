...
<html lang="es">
    ...
    @section('menu')
    @parent
    <div class="row espacioAbajo wow bounceInUp">
        ...
        <div class="container espacioArriba espacioAbajo">
            ...
            <div class="col-lg-5 fuenteBlanca text-center wow bounceInRight">
                ...
                <h4><span class="glyphicon glyphicon-ok"></span>&nbsp;&nbsp;Joven entre 18 y 35 años.<br><br>
                    <span class="glyphicon glyphicon-ok"></span>&nbsp;&nbsp;Nacionalidad de cualquiera de los países centroamericanos.<br><br>
                    ...
                    <span class="glyphicon glyphicon-ok"></span>&nbsp;&nbsp;Adaptabilidad a situaciones nuevas y ser capaz de trabajar bajo presión
                </h4>
            </div>
        </div>
    </div>
